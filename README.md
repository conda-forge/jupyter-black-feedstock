...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter-black-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15633&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-black-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter-black` can be installed with:

```
conda install jupyter-black
```

It is possible to list all of the versions of `jupyter-black` available on your platform with:
